  ...
  return (
    <div className="text-white flex flex-col items-center justify-center h-screen p-1">
      <div className="flex flex-row">
        ...
        <h1 className="text-5xl font-bold mt-5">OncoGPT</h1>
        </div>
        ...
        <div className="flex space-x-3 text-center">
          <div>
            ...
            <div className="space-y-2 rounded-xl">
              <p className="info-text">What is Breast Cancer?</p>
              <p className="info-text">Types of Lung Cancer?</p>
              <p className="info-text">Treatments for Skin Cancer?</p>
            </div>
          </div>
          ...
          <div >
            ...
            <div className="space-y-2">
              ...
              <p className="info-text">Types of treatments?</p>
              <p className="info-text">Stages of Testicle Cancer?</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="info-text">Skin cancer and its types?</p>
              <p className="info-text">Describe diagnostic tools for breast cancer</p>
              <p className="info-text">Guidance on post-treatment recovery</p>
            </div>
          </div>
        </div>
    </div>
